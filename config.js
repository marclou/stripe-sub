...
const config = {
  ...
  colors: {
    ...
    theme: "dark",
    // REQUIRED — This colors will be reflected on the whole app (loading bar, Chrome tabs, etc..). By default it takes the primary color from your DaisyUI theme. HEX only.
    main: themes[`[data-theme=dark]`]["primary"],
    // OR you can just do this to use a custom color:
    // main: "#f37055",
  },
